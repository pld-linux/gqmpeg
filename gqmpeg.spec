...
GQmpeg jest nakładką graficzną dla mpg123 - odtwarzacza plików
zapisanych w formacie MP3. Zawiera wszystkie standardowe opcje,
możliwość zmiany wyglądu przy pomocy 'skórek'. GQmpeg korzysta z
biblioteki GTK+ i wymaga mpg123 w wersji 0.59p lub wyższej.
